...
const About = () => {
  return (
    <div className="xl:w-[1300px] lg:w-[90%] w-[95%] m-auto sm:mt-20 mt-10 border-b border-zinc-300 pb-10 pt-[120px]">
      <h1 className="text-center xl:text-[36px] sm:text-[32px] text-xl sm:leading-[2.5rem] font-Roboto leading-[1.75rem] text-[#044E83] font-extrabold m-auto md:w-[95%]">
      ...
      <p className="sm:mt-10 mt-7 mb-8 xl:text-[1.25rem] sm:text-[1.2rem] text-[1rem] text-zinc-800 font-Roboto sm:tracking-wider tracking-normal text-justify">
